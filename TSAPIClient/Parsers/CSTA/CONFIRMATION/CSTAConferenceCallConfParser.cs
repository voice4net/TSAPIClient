...
{
    public class CSTAConferenceCallConfParser : ICSTAConfirmationParser
    {
        ...
        public CSTAConfirmationEvent Parse(IStructReader reader)
        {
            try
            {
                ...
                CSTAConfirmationEvent cstaConfirmation = new CSTAConfirmationEvent { u = { conferenceCall = conferenceCall } };
        ...
        {
            get { return Constants.CSTA_CONFERENCE_CALL_CONF; }
        }
    }
}
